...
export default function Login() {
  ...
  return (
    ...
    >
            ...
            {Object.values(MOCK_USERS).map((u) => (
              ...
              >
                <div style={{ textAlign: "left" }}>
                  <p style={{ fontSize: "13px", fontWeight: "500", color: "var(--color-text-primary)", margin: 0 }}>{u.nome}</p>
                  <p style={{ fontSize: "11px", color: "var(--color-text-tertiary)", margin: 0 }}>{u.email}</p>
                </div>
      ...
      <p style={{ fontSize: "12px", color: "var(--color-text-tertiary)", marginTop: "1.5rem" }}>Projeto Integrador V — Unifio 2026</p>
    </div>
  );
}
